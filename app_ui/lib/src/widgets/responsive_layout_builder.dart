  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= LaporanCheckBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= LaporanCheckBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= LaporanCheckBreakpoints.large) {
